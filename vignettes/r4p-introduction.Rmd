...
| ['oocquire'](https://docs.r4photobiology.info/oocquire/) (Not in CRAN)    | Data acquisition and control of Ocean Optics (now Ocean Optics) spectrometers.                                                                                                                           |
| ['rOmniDriver'](https://docs.r4photobiology.info/rOmniDriver/) (Not in CRAN) | Interface to OmniDriver drivers for communication with spectrometers from Ocean Optics (now Ocean Optics)                                                                                              |
